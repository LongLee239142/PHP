...
if (!isset($_GET['id'])) {
    // Redirect to 404 page if post ID is not provided
    header("Location: 404.php");
    exit(); // Stop execution of the script
}
...
if ($result->num_rows > 0) {
    ...
    $sql_categories = "SELECT * FROM categories_posts";
    $result_categories = $conn->query($sql_categories);
} else {
    // Redirect to 404 page if post does not exist
    header("Location: 404.php");
    exit(); // Stop execution of the script
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1>Edit Post</h1>
                    <form id="editPostForm" action="php/editpost_handler.php" method="post"  enctype="multipart/form-data">
                        <!-- Title -->
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="short_description" name="short_description"><?php echo $short_description; ?></textarea>
                        </div>

                        <!-- Post Detail -->
                        <div class="form-group">
                            <label for="post_detail">Post Detail</label>
                            <textarea id="post_detail" name="post_detail" rows="6">
    <?php
    // Read the content of the HTML file
    $post_detail_content = file_get_contents("../eproject/" . $post_detail);

    // Output the content
    echo htmlspecialchars($post_detail_content);
    ?>
</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img src="../eproject/<?php echo $post_image; ?>" alt="Post Image" style="max-width: 200px;">
                        </div>
    ...
    <script>
        document.getElementById('editPostForm').addEventListener('submit', function(e) {
            ...
            if (validateForm(formData)) {
                fetch('php/editpost_handler.php', {
                        method: 'POST',
                        body: formData
                    })
                    .then(response => {
                    ...
                    .then(data => {
                        if (data.success === 'true') {
                            displayAlert('success', 'Your post has been successfully updated.</a>.');
                            form.reset();
